...
public partial class Parent_Default : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("ParentViewReport", conn);
        ...
        if (!this.IsPostBack)
        {
            ...
            {
                SqlCommand cmd1 = new SqlCommand("ParentViewReport");
                ...
                using (cmd1)
                {
                    ...
                    DropDownList1.DataTextField = "r_id";
                    DropDownList1.DataValueField = "r_id";
                    DropDownList1.DataBind();
                    con.Close();
                }
            }
            DropDownList1.Items.Insert(0, new ListItem("--View reports--", "0"));
        }
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = new SqlCommand("ParentReplyReport", conn);
        cmd.CommandType = CommandType.StoredProcedure;
        ...
        cmd.Parameters.Add(new SqlParameter("@reply", TextBox1.Text));
       

        SqlDataReader rdr = cmd.ExecuteReader(CommandBehavior.CloseConnection);
        conn.Close();
        Response.Redirect("/Parent/ViewReportsAboutMyChild");
