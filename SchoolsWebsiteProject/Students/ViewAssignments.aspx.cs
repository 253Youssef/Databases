...
public partial class Students_ViewAssignments : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        if (this.IsPostBack)
        {
            ...
            SqlCommand cmd = new SqlCommand("StudentViewAssignments", conn);
            string username = (string)(Session["username"]);
            string password = (string)(Session["password"]);
            cmd.Parameters.Add(new SqlParameter("@usernameexist", username));
            cmd.Parameters.Add(new SqlParameter("@passexist", password));
    ...
    {
        Session["ccode"] = DropDownList1.SelectedValue;
        Response.Redirect("/Students/SolveAssignments");
    }
}